...
- Implementation :
  ...
  * Software Section :
  - Developed STR (Speech and Text Recognition) App using 'MIT App Inventor' for connecting with external Bluetooth module to transmit Text & Voice based messages.
